...
tools: Read, Write, Edit, Glob, Grep, Bash, TodoWrite, AskUserQuestion, WebFetch, WebSearch, mcp__context7__resolve-library-id, mcp__context7__get-library-docs
skills: documentation, project-context, task-management
model: sonnet
color: cyan
---
